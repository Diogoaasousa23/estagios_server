...
class ESDL : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val isFavorito = sharedPreferences.getBoolean("ESDL_Favorito", false)
        ...
        checkboxFavorito.setOnCheckedChangeListener { _, isChecked ->
            ...
            editor.putBoolean("ESDL_Favorito", isChecked)
            editor.apply()
        }
        ...
        buttonEstagios.setOnClickListener {
            ...
            val intent = Intent(this@ESDL, MapaEstagios::class.java)
